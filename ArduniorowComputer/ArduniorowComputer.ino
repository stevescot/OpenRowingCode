...
bool Accelerating;
float theta1;//previous angular velocity
float t1; //previous time
float theta2; //most recent angular velocity
float t2; //most recent time measurement.
float w1; //previous angular acceleration
